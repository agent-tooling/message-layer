...
export const webhookEventSupport = {
  ...
  "command.registration_requested": true,
...
export const webSocketEventSupport = {
  ...
  "command.registration_requested": "not-delivered",
  "command.registered": "not-delivered",
  "command.deleted": "not-delivered",
